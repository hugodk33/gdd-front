...
export default function itensList({
    ...
    const [clients, setClients] = useState(itensprop)
            ...
            <div className="flex flex-col items-center justify-items-center content-center p-4 mb-3 border border-gray-100 rounded-md ">
                {
                    clientKinshipList.length > 0 ?
                        ...
                        <span className="flex flex-col items-center justify-items-center content-center ">
                            ...
                            <h1 className="uppercase mb-3 text-center text-lg"> Nenhum <b>item</b> selecionado </h1>
                        </span>
                }
                <hr />
                <BtnOutline onClick={() => toggleModalclients()}>selecionar itens</BtnOutline>
            </div>
            <Modal isOpen={modalIsOpen} style={customStyles} ariaHideApp={false}>
                <div className="flex flex-col" ref={modalRef}>
                    <h1 className='text-3xl pb-4 pt-2'>Adicionar item</h1>
